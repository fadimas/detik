...
<section class="sr-icons">
  <div class="container">
    ...
    <div class="col-lg-6 text-justified notif">
        <p class="notification">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum sed est tempus, eleifend dolor sollicitudin, commodo orci. Quisque elit felis, mattis quis aliquam ac, ornare ultrices turpis. </p>
    </div>
    <div class="col-lg-3"></div>
    </div>
    <div class="row">
        <div class="row text-center">
        <button type="submit" class="btn btn-default"><a href="<?php echo base_url('apply/preview'); ?>" target="_blank">Download</a></button>
    </div>
