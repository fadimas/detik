                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                            ...
                            <button  class="btn btn-danger" type="button" title="Hapus SubKategori"><a onclick="return konfirmasi()" style="color: #fff; text-align: left;" href="<?php echo base_url("adv/hapussubkategori/$s->job_id")?>" title="hapus"><i class="fa fa-trash" aria-hidden="true"></i> Hapus </a>                              
                            </button>
