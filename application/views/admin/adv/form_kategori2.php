                  ...
                  <div class="well bs-component">
                    ...
                    <fieldset>
                        ...
                        <table class="col-lg-10">
                            ...
                            <td class="col-lg-10"><input id="inputEmail" type="text" name="nama_tipe" value="<?php echo $kategori->nama_tipe; ?>" placeholder="Nama Kategori" class="form-control" required="true"  title="Masukkan hanya huruf" ></td>
                            </tr>
                      ...
                      <!-- <fieldset>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-lg-10">
                            <input type="text" id="inputEmail" name="nama_tipe" value="<?php //echo $kategori->nama_tipe; ?>" class="form-control" required="true" pattern="[A-Za-z].{1,}" title="Masukkan hanya huruf">
                          </div>
                        </div>
                        <div class="form-group">
                          <div class="col-lg-10 col-lg-offset-2">
