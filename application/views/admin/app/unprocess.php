                          ...
                          <div class="dropdown">
                            <button style="background-color: #e5e5e5; color: #000;" class="btn btn-info dropdown-toggle" type="button" data-toggle="dropdown">Status
                              ...
                              <ul class="dropdown-menu" >
                                <li><div style=" padding: 2% 2% 2% 2%; "><button onclick="return konfirmasi()" style="text-align: left; background-color: #fff; color: #000; width: 100%;" class="btn btn-default" type="submit" name="status" value="shortlist" title="shortlist"> <i class="fa fa-th-list" aria-hidden="true"></i> Shortlist</button></div></li>

                                <li><div style="text-align: left; padding: 2% 2% 2% 2%; "><button onclick="return konfirmasi()" style="text-align: left; background-color: #fff; color: #000; width: 100%;" class="btn btn-warning" type="submit" name="status" value="interview user" title="Interview user"> <i class="fa fa-user" aria-hidden="true"></i> Interview User</button></div></li>
