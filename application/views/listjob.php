    ...
    <div class="container">
      <div class="row text-back">
        <div class="col-lg-6 col-lg-push-1 col-md-6 col-sm-6 col-xs-6 migrasi">
            <a href="<?php echo base_url()?>"><i class="fa fa-chevron-left backarr" aria-hidden="true"></i><span class="backto"> Back to previous page</span></a>
        </div>
    ...
    <section class="small-padding">
        <div class="container">
            <div class="content">
                ...
                ?>
                   <li style='list-style-type: none; padding-left: -10%;'>
                <div class="row content-list">    
                    ...
                    <div class="col-lg-7 col-md-6 col-sm-6 col-xs-12">
                        ...
                        <a class="botton" href="<?php echo base_url('job/jobdes/'.$job->jobslug); ?>"> Find Out More <i class="fa fa-caret-right"></i></a>
                    </div>
